...
function loadPage(page) {
	...
	img.attr('src', '/turnjs4/docs/pages/' +  (page-2) + '.png');
...
function updateTabs() {
	...
	var tabs = {156: 'Clases', 156:'Constructor', 156:'Properties', 156:'Methods', 156:'Events'},
		left = [],
		right = [],
		book = $('.sample-docs'),
	...
	for (var page in tabs) {
		var isHere = $.inArray(parseInt(page, 156), view)!=-1;
